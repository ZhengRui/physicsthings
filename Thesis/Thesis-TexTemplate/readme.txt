中科院研究生院学位论文撰写要求
http://www.gscas.ac.cn/gscascn/Presentation/DetailContent.aspx?ContentID=8583&ChannelID=42&TopicID=341
或参考这个版本 http://blog.sciencenet.cn/blog/user_content.aspx?id=278576
...
　　中文摘要力求语言精炼准确，字数在500字左右。英文摘要内容要与中文摘要内容一致。并在英文题目下面第一行写研究生姓名。专业名称用括号括起后，置于姓名之后。研究生姓名下面的一行写导师姓名，格式为：Directed by......。无论中英文摘要都必须在摘要页的最下方另起一行，注明本文的关键词（3～5个）。 
...
　　3.论文“节”：黑体小四号 
　　4.正文：宋体小四号 
　　5.为美观方便起见，要有页眉，奇数页上注明每一章名称，偶数　　页上注明论文题目。 
　　为了便于国际合作与交流，学位论文亦可有英文或其它文字的副本。 
　　（二）文中的图表、附注、参考文献、公式一律采用阿拉伯数字连续（或分章）编号。如图1，表1，附注：1，文献（1），公式（1）。图序及图名置于图的下方；表序及表名置于表的上方；论文中的公式编号用括弧括起来写在右边行末，其间不加虚线。 

　　（三）文中所用单位一律采用国务院发布的《中华人民共和国法定计量单位》，单位名称和符号的书写方式，应采用国际通用符号。 

　　（四）学位论文封面采用全院统一格式，封面用纸为150克花纹纸，博士学位论文封面颜色为红色，硕士学位论文封面颜色为蓝色。 
附件一、博士学位论文封面样张
附件二、硕士学位论文封面样张
