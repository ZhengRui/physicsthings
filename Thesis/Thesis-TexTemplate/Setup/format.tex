...
%-------------------------------------------------------------------------%
%   Copyright 2003  by  Wu Ying nian    (hdwyn@sohu.com)
%=========================================================================%
...
%---------------------------- 数学公式设置 ------------------------------%
\setlength{\abovedisplayskip}{2pt plus2pt minus1pt}     %公式前的距离
...
%----------------------- 定义章节标题格式 ----------------------------%
\titleformat{\chapter}[hang]{\normalfont\Large\filcenter\CJKfamily{hei}}
    {\Large{\chaptertitlename}}{14pt}{\Large}
...
\newcommand{\reffigure}{\arabic{chapter}.\arabic{figure}}
...
\fancyhead[LE]{\color{black}\CJKfamily{fs}蒙特卡洛方法及其在磁性模型中的应用}     % 在book文件类别下,
\fancyhead[RO]{\color{black}\CJKfamily{fs}\leftmark}     % \leftmark自动存录各章之章名,
\fancyfoot[L]{\CJKfamily{fs}}             % \rightmark记录节标题
\fancyfoot[C]%                                          % [RE][LO]
{\CJKfamily{hei} \thepage} \fancyfoot[R]{\CJKfamily{fs}}
